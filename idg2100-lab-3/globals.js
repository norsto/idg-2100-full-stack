...
console.log("N of env vars: ", envCount);
...
console.log("N of env vars: ", envCount2)


//Log used memory in MB
// this process memory consumption
const memUseInMB = (process.memoryUsage().rss / (1024 * 1024) * 100) / 100;
console.log(`Total mem used by the nodejs process: ${memUseInMB}MB`);